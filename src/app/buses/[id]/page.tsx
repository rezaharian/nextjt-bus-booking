      ...
      <main className="flex-grow px-4 sm:px-6 lg:px-8  mt-9 py-8 max-w-3xl mx-auto">
            ...
            return (
              <div
                ...
                className={`flex flex-col items-center text-xs cursor-pointer ${
                  isBooked ? 'text-gray-300' : isSelected ? 'text-yellow-500' : 'text-green-500'
                }`}
              >
                <FaChair
                  size={28}
        ...
        {selectedSeats.length > 0 && (
          <div className="text-center">
            <button
              onClick={handleNext}
              className="bg-blue-900 hover:bg-yellow-600 text-white font-medium py-2 px-6 rounded transition"
            >
